...
node[:apache][:listen_ports]=[ "8080","443" ]
...
directory "#{node[:wordpress][:dir]}/wp-content/cache/" do
  mode "0777"
  action :create
end  

template "#{node[:wordpress][:dir]}/.htaccess" do
  source "htaccess.erb"
  owner "www-data"
  group "www-data"   
  mode "0644"
...
include_recipe %w{php::php5 php::module_mysql php::module_curl}
